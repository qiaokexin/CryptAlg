...
public class SM3 {
    ...
    public static String hash(String str_source) throws IOException {
        byte[] source = hexStringToByteArray(str_source.replaceAll(" ",""));
        ...
        String res = byteArrayToHexString(vi1);
        return res;
    }
